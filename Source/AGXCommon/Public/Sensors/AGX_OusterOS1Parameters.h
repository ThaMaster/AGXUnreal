...
#include "AGX_OusterOS1Parameters.generated.h"

/**
 * Parameters used to create a Lidar Sensor Component using Lidar Model OusterOS1.
 */
UCLASS(ClassGroup = "AGX_Sensor", Category = "AGX")
class AGXCOMMON_API UAGX_OusterOS1Parameters : public UAGX_LidarModelParameters
{
	GENERATED_BODY()
