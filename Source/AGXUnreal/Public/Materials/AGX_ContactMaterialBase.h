 ...
 * In-Editor they are treated as assets and can be referenced by the Contact Material Registrar
 * Component.
 *
 * When game begins playing, one UAGX_ContactMaterialInstance will be created for each
 * UAGX_ContactMaterialAsset that is referenced by the Contact Material Registrar Component. The
 ...
 * will be returned.
 *
 * Note that this means that UAGX_ContactMaterialAssets that are not referenced the Contact Material
