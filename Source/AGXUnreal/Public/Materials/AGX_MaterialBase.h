 ...
 *
 * Materials are created by the user in-Editor by creating a UAGX_MaterialAsset. In-Editor they are treated as assets
 ...
 *
 */
UCLASS(ClassGroup = "AGX", Category = "AGX", abstract, AutoExpandCategories = ("Material Properties"))
...
public:
	...
	/**
	 * If PlayingWorld is an in-game World and this material is a UAGX_MaterialAsset, returns a UAGX_MaterialInstance
