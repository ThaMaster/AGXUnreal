...
UAGX_ContactMaterialInstance* UAGX_ContactMaterialBase::GetOrCreateInstance(UWorld* PlayingWorld, UAGX_ContactMaterialBase*& Property)
{
	...
	{
		UE_LOG(LogAGX, Log, TEXT("UAGX_ContactMaterialBase::GetOrCreateInstance is swapping a property (to \"%s\" from \"%s\")."),
...
#define COPY_MAT_PROPERTY(Source, Name) { Name = Source->Name; }
