...
class AGXSHADERS_API FExampleComputeShader: public FGlobalShader
{
public:
...
IMPLEMENT_GLOBAL_SHADER(FExampleComputeShader, "/AGXShadersShaders/ExampleComputeShader.usf", "ExampleComputeShader", SF_Compute);
