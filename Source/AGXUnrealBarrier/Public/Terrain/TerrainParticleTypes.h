...
#include "TerrainParticleTypes.generated.h"
 ...
 */
USTRUCT(BlueprintType, meta = (ShortToolTip= "ParticleDataById struct contains data for the particles generated by AGX. The data at a index will always refer to the same particle."))
