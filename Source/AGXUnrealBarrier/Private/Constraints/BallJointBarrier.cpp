...
void FBallJointBarrier::AllocateNativeImpl(const FRigidBodyBarrier* RigidBody1, const FVector* FramePosition1,
	...
	const FQuat* FrameRotation2)
{
	...
	NativeRef->Native = new agx::BallJoint(NativeRigidBody1, NativeFrame1.get(), NativeRigidBody2, NativeFrame2.get());
}
