...
void FROS2PublisherBarrier::AllocateNative(EAGX_ROS2MessageType InMessageType, const FString& Topic)
{
	...
	switch (InMessageType)
	{
		...
		case EAGX_ROS2MessageType::StdMsgsFloat32:
			Native = std::make_unique<FPublisherFloat32>(new PublisherFloat32(Convert(Topic)));
			return;
		case EAGX_ROS2MessageType::StdMsgsInt32:
			Native = std::make_unique<FPublisherInt32>(new PublisherInt32(Convert(Topic)));
			return;
	}
